...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li><a href="#">Form Nota Kredit</a></li>
    </ol>
</section>
			...
			<div class="form-group" id="form_report">
				<div class="alert alert-success alert-dismissable">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
					  Kode NK :  <a href="<?=base_url()?>?page=keuangan/nk_track&action=track&kode_nk=<?=$_GET['pesan']?>" target="_blank"><?=$_GET['pesan'] ?></a>  Berhasil Di posting
				</div>
			</div>
			<?php  }  ?>
...
<div class="tabbable">
	<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
		<li <?=$class_form?>>
			<a data-toggle="tab" href="#menuFormNk">Form Nota Kredit</a>
		</li>
        <li <?=$class_tab?>>
			<a data-toggle="tab" href="#menuListNk">List Nota Kredit</a>
		</li>
    </ul>

<div class="row">
    <div class="tab-content">
        <div id="menuFormNk" <?=$class_pane_form?>>
            <div class="col-lg-12">
                        ...
                        <div class="form-horizontal">
    						...
    						?>
	    						...
	    						<div class="form-group">
	                              	...
	                              	<div class="col-lg-4">
	                                 	<input type="text" class="form-control" name="kode_nk" id="kode_nk" placeholder="Auto..." readonly value="">
	                              	</div>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-4">
	                                    <div class="input-group">
	                                        <input class="form-control date-picker-close" value="<?=date("m/d/Y")?>" id="tgl_buat" name="tgl_buat" type="text" autocomplete="off" placeholder="Tanggal SPK ..." readonly />
	                                ...
	                                <div class="col-lg-4">
	                                    <div class="input-group">
	                                        <input class="form-control date-picker-close" value="<?=date("m/d/Y")?>" id="tgl_jth_tempo" name="tgl_jth_tempo" type="text" autocomplete="off" placeholder="Tanggal SPK ..." readonly />
	                                        <span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
	                                    </div>
	                                </div>
	                            </div>
                                ...
                                <div class="form-group">
		                                <div class="col-lg-12">
		                                    <div class="pull-left">
		                                        <a class="btn btn-success" id="tambah_nk"><i class="fa fa-plus"></i> Add</a>
		                                    </div>
		                                </div>
		                             </div>
                                        ...
                                        <div class="col-lg-12">
                                            <table id="" class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    ...
                                                    <tr id="show_input_nk" style="display:none">
								...
								<div class="form-group col-md-6">
                    				<?php
                                        ...
                                        <a href="<?=base_url()?>?page=keuangan/nk&halaman=NOTA%20KREDIT" class="btn btn-danger"><i class=" fa fa-reply"></i> Batal</a>
               					</div>
		...
		<div id="menuListNk" <?=$class_pane_tab?>>
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="box-body">
							<table id="example1" class="table table-striped table-bordered table-hover" width="100%" >
								...
								<tbody>
									<?php
										$n=1;
										if(mysql_num_rows($q_nk) > 0) {
											while($data = mysql_fetch_array($q_nk)) {
									?>
									<tr>
										<td style="text-align: center; width:5px"> <?php echo $n++ ?></td>
										<td>
											<a href="<?=base_url()?>?page=keuangan/nk_track&action=track&kode_nk=<?=$data['kode_nk']?>">
												<?php echo $data['kode_nk'];?>
											</a>
										</td>
                                        ...
                                        <td style="text-align: center">
                                            <a href="<?=base_url()?>r_cetak_nk.php?kode_nk=<?=$data['kode_nk']?>" title="cetak" target="_blank">
...
<script>
    ...
    $("#saveForm").on('submit',(function(e) {
      	e.preventDefault();
         	$(".animated").show();
         	$.ajax({
	            url: "<?=base_url()?>ajax/j_nk.php?func=save",
	            type: "POST",
	            ...
	            success: function(html)
	            {
	               var msg = html.split("||");
	               if(msg[0] == "00") {
	                  window.location = '<?=base_url()?>?page=keuangan/nk&pesan='+msg[1];
	               } else {
	                  notifError(msg[1]);
	               }
	               $(".animated").hide();
	...
	$('#kode_pelanggan').change(function(){
  	...
  	$("#tambah_nk").click(function(event) {
		event.preventDefault();
		document.getElementById('show_input_nk').style.display = "table-row";
  	...
  	$("#ok_input").click(function(event) {
		...
		$.ajax({
			type: "POST",
			url: "<?=base_url()?>ajax/j_nk.php?func=add",
			data: "kode_coa="+kode_coa+"&harga="+harga2+"&ket_dtl="+ket_dtl+"&id_form="+id_form,
            cache:false,
			success: function(data) {
				$('#detail_input_nk').html(data);
				document.getElementById('show_input_nk').style.display = "none";
			}
		  });
	    return false;
	});
