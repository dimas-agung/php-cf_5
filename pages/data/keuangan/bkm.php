    ...
    <div class="box-body">
		...
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li <?=$class_form?>>
					<a data-toggle="tab" href="#menuFormBkm">Form Bukti Kas Masuk</a>
				</li>
                <li <?=$class_tab?>>
					<a data-toggle="tab" href="#menuListBkm">List Bukti Kas Masuk</a>
				</li>
            </ul>
...
$("#ok_input").click(function(event) {
	...
	if (selisih > 0 && (kode_coa == '' || kode_coa == null  || kode_coa == 'null')) {
		alert('Mohon isi Kode COA');
		return false;
	}
