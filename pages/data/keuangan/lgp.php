<?php 
   include 'pages/data/script/lgp.php'; 
?>
               ...
               <div class="form-horizontal">
                  <form action="" method="post" enctype="multipart/form-data" role="form" id="form-lap">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label" style="text-align: center">Per Tanggal :</label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group" style="text-align:center">
                        <button type="button" name="submit" class="btn btn-primary pb-load" tabindex="4"><i class="fa fa-list"></i> Tampilkan</button>
             		      ...
             		      <a href="#" id="lgp" class="btn btn-success pull-right fa fa-download"> Download CSV</a>
  ...
  $(document).ready(function(){
    $('.pb-load').click(function(){
  		...
  		return false;
   		...
   		$.ajax({
   			type: "POST",
   			url: '<?php echo base_url();?>ajax/j_lgp.php?func=gross_profit',
   			data: data,
   			cache: false,
...
<script> 
   ...
   function exportTableToCSV($table, filename) {
     ...
     $("#lgp").on('click', function (event) {
     	
     	exportTableToCSV.apply(this, [$('#example1'), 'Laporan Gross Profit.csv']);
