                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <form action="" method="post" enctype="multipart/form-data" id="form-lpj">   
                                    ...
                                    <div class="col-sm-5">
                                        <select id="pelanggan" name="pelanggan" class="select2" style="width: 100%;">
                                            ...
                                            while($row_pelanggan = mysql_fetch_array($q_pelanggan)) { ;?>
                                                ...
                                                <option 
                                                    data-kode="<?php echo $row_pelanggan['kode_pelanggan'];?>"
                                                    value="<?php echo $row_pelanggan['kode_pelanggan'];?>" 
                                                    <?php if($row_pelanggan['kode_pelanggan']==$row_pelanggan){echo 'selected';} ?>><?php echo $row_pelanggan['kode_pelanggan'].'&nbsp;&nbsp;||&nbsp;&nbsp;'.$row_pelanggan['nama_pelanggan'];?> </option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                        ...
                                        <select id="cabang" name="cabang" class="select2" style="width: 100%;">
                                            ...
                                            while($row_cabang = mysql_fetch_array($q_cabang)) { ;?>
                                                ...
                                                <option
                                                    ...
                                                    <?php if($row_cabang['kode_cabang']==$row_cabang){echo 'selected';} ?>><?php echo $row_cabang['kode_cabang'].'&nbsp;&nbsp;||&nbsp;&nbsp;'.$row_cabang['nama_cabang'];?> </option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                        ...
                                        <select id="gudang" name="gudang" class="select2" style="width: 100%;">
                                            ...
                                            while($row_gudang = mysql_fetch_array($q_gudang)) { ;?>
                                                ...
                                                <option 
                                                    ...
                                                    <?php if($row_gudang['kode_gudang']==$row_gudang){echo 'selected';} ?>><?php echo $row_gudang['kode_gudang'].'&nbsp;&nbsp;||&nbsp;&nbsp;'.$row_gudang['nama_gudang'];?> </option>
                                                <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" name="tgl_awal" id="tgl_awal" class="form-control" autocomplete="off" value="<?=date("m/d/Y")?>">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" name="tgl_akhir" id="tgl_akhir" class="form-control" autocomplete="off" value="<?=date("m/d/Y")?>">
                                            <span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-12" style="text-align: center">
                                    ...
                                    while($res = mysql_fetch_array($q_akses)) {; ?>    
                                      ...
                                      ?>  
                                          ...
                                          <button type="button" name="submit" class="btn btn-primary lpj-load" tabindex="10"><i class="fa fa-search" ></i> Cari </button> 
                                    <?php } } } ?>
                            </div>
...
$(document).ready(function(){
    $('.lpj-load').click(function(){
		...
		data        = $("#form-lpj").serialize();
		$(".animated").show();
		$.ajax({
			type: "POST",
			url: '<?php echo base_url();?>ajax/j_lpj.php?func=lpj-load',
			data: data,
			cache: false,
