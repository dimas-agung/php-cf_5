<?php
    include "pages/data/script/sk_script.php";
...
<div class="box-body">
            ...
            <?php if (isset($_GET['pesan'])){ ?>
                <div class="form-group" id="form_report">
                  <div class="alert alert-success alert-dismissable">
                      ...
                      Kode SK :  <a href="<?=base_url()?>?page=logistik/sk_track&action=track&kode_sk=<?=$_GET['pesan']?>&halaman= TRACK STOK KELUAR" target="_blank"><?=$_GET['pesan'] ?></a>  Berhasil Di posting
                  </div>
                </div>
            <?php  }  ?>
    ...
    <div class="tabbable">
        <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
            <li <?=$class_form?>>
                <a data-toggle="tab" href="#menuFormSk">Form Stok Keluar</a>
            </li>
            <li <?=$class_tab?>>
                <a data-toggle="tab" href="#menuListSk">List Stok Keluar</a>
            </li>
        </ul>
    ...
    <div class="row">
        <div class="tab-content">
            ...
            <div id="menuFormSk" <?=$class_pane_form?>>
                <div class="col-lg-12">
                            ...
                            <div class="form-horizontal">
                                ...
                                <form role="form" method="post" action="" id="saveForm">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" style="text-align:left">Kode SK</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="kode_sk" id="kode_sk" placeholder="Auto..." readonly value="">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label style="text-align:left" class="col-lg-2 col-sm-2 control-label">Tanggal SK</label>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="pull-left">
                                                <a class="btn btn-success" id="tambah_sk"><i class="fa fa-plus"></i> Add</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div style="overflow-x:auto;">
                                            <table id="" class="" rules="all">
                                                <thead>
                                                    ...
                                                    <tr id="show_input_sk" style="display:none">
                                                            ...
                                                            <td id="load_harga">
                                                                <input style="text-align: right" class="form-control" type="text" name="harga" id="harga" value=""/>
                                                                <input style="text-align: right" class="form-control" type="hidden" name="tgl_awal" id="tgl_awal" value="" readonly/>
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        while($res = mysql_fetch_array($q_akses)) {; ?>
                                          ...
                                          <?php } } } ?>
                                              ...
                                              <a href="<?=base_url()?>?page=logistik/sk&halaman= STOK KELUAR" class="btn btn-danger"><i class=" fa fa-reply"></i> Batal</a>
                                    </div>
            ...
            <div id="menuListSk" <?=$class_pane_tab?>>
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <table id="example1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                        $n=1; if(mysql_num_rows($q_sk) > 0) {
                                        while($data = mysql_fetch_array($q_sk)) {
                                    ?>

                                    <tr>
                                        <td style="text-align: center"> <?php echo $n++ ?></td>
                                        <td>
                                            <a href="<?=base_url()?>?page=logistik/sk_track&action=track&kode_sk=<?=$data['kode_sk']?>&halaman= TRACK STOK KELUAR"> <?php echo $data['kode_sk'];?>
                                            </a>
                                        </td>
                                        ...
                                        <td style="text-align: center">
                                            <a href="<?=base_url()?>r_cetak_sk.php?kode_sk=<?=$data['kode_sk']?>" title="cetak" target="_blank">
...
<script>
        ...
        $("#saveForm").on('submit',(function(e) {
            ...
            if(grand_total != 0) {
                ...
                $.ajax({
                    ...
                    url: "<?=base_url()?>ajax/j_sk.php?func=save",
                    type: "POST",
                    ...
                    success: function(html)
                    {
                        var msg = html.split("||");
                        if(msg[0] == "00") {
                            window.location = '<?=base_url()?>?page=logistik/sk&halaman= STOK KELUAR&pesan='+msg[1];
                        } else {
                            notifError(msg[1]);
                        }
                        $(".animated").hide();
    ...
    $("#tambah_sk").click(function(event) {
        ...
        if(status == 'true') {
            ...
            document.getElementById('show_input_sk').style.display = "table-row";
    ...
    $('#kode_barang').change(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?=base_url()?>ajax/j_sk.php?func=loadsatuan",
    ...
    $('#kode_barang').change(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?=base_url()?>ajax/j_sk.php?func=loadharga",
    ...
    $("#batal_input").click(function(event) {
        event.preventDefault();
        document.getElementById('show_input_sk').style.display = "none";
    });
    ...
    $("#ok_input").click(function(event) {
        ...
        if(status == 'true') {
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>ajax/j_sk.php?func=add",
                data: "kode_barang="+kode_barang+"&kode_satuan="+kode_satuan+"&satuan="+satuan+"&harga="+harga+"&tgl_awal="+tgl_awal+"&qty="+qty+"&subtot="+subtot+"&coa_debet="+coa_debet+"&coa_kredit="+coa_kredit+"&keterangan_dtl="+keterangan_dtl+"&id_form="+id_form,
                cache:false,
                success: function(data) {
                    $('#detail_input_sk').html(data);
                    document.getElementById('show_input_sk').style.display = "none";
                }
            });
        }else{
