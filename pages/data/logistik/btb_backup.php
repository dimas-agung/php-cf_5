    ...
    <div class="box-body">
		...
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li <?=$class_form?>>
					<a data-toggle="tab" href="#menuFormBtb">Form Bukti Terima Barang</a>
				</li>
                <li <?=$class_tab?>>
								...
								<div class="panel-body">
                                	<div class="form-horizontal">
			                         ...
			                         <div class="form-group">
			                         	...
			                         	<div class="col-lg-4">
			                             	<input type="text" class="form-control" name="supplier" id="supplier" placeholder="Pilih DOC OP dahulu ..." value="" readonly>
				                     ...
				                     <div class="form-group">
				                         ...
				                         <div class="col-lg-4" id="load_gudang">
				                         	<select id="kode_gudang" name="kode_gudang" class="select2" style="width: 100%;" disabled>
                                                <option value="">-- Pilih DOC OP dahulu --</option>
                                            </select>
				                         </div>
				                     </div>
				                     ...
				                     <div class="form-group">
				                         ...
				                         <div class="col-lg-4" id="load_op">
				                            <select id="no_op" name="no_op" class="select2" style="width: 100%;">
						                        <option value="0">-- Pilih Kode OP --</option>
						                        <?php
												//CEK JIKA KODE_OP ADA MAKA SELECTED
												(isset($row['id_btb']) ? $kode_op=$row['kode_op'] : $kode_op='');
												//UNTUK AMBIL kode_op nya
							                    while($row_doc_op = mysql_fetch_array($q_doc_op)) { ;?>

							                    	<option
							                    		data-kode-supplier="<?php echo $row_doc_op['kode_supplier'];?>"
							                    		data-supplier="<?php echo $row_doc_op['kode_supplier'].'&nbsp;&nbsp;||&nbsp;&nbsp;'.$row_doc_op['nama_supplier'];?>"
							                    		data-gudang="<?php echo $row_doc_op['nama_gudang'];?>"
							                    		value="<?php echo $row_doc_op['kode_op'];?>" <?php if($row_doc_op['kode_op']==$kode_op){echo 'selected';} ?>><?php echo $row_doc_op['kode_op'];?>
							                    	</option>
                                            ...
                                            <table id="" class="" rules="all">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 300px">Deskripsi Barang</th>
                                                        <th style="width: 100px">Satuan</th>
                                                        <th style="width: 150px">Q OP</th>
									...
									<table id="example1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr <?= $warna?>>
                                                ...
                                                <td style="text-align:right; font-size: 12px"> <?php echo number_format($data['qty']);?></td>
