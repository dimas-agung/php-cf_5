...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li><a href="#">Track Stok Keluar</a></li>
    </ol>
        
    <section class="content">
        <a href="#modalAddItem" class="btn btn-md btn-info"  data-toggle="modal"><i class=" fa fa-book"></i> JURNAL </a>
        <a href="<?=base_url()?>?page=logistik/sk&halaman= STOK KELUAR" class="btn btn-md btn-danger pull-right" ><i class=" fa fa-reply"></i> BACK </a><br/>
   </section>
</section>
...
<div class="box box-info">
    <div class="box-body">
		...
		<?php
			// HEADER
			$res_hdr = mysql_fetch_array($q_sk_hdr); 
		?>	
                                ...
                                <div class="panel-body">
                                	<div class="form-horizontal">
                                 	      <div class="form-group">
                                             ...
                                             <div class="col-lg-4">
                                                 <input type="text" class="form-control" name="kode_sk" id="kode_sk" placeholder="Auto..." readonly value="<?=$res_hdr['kode_sk']?>">
                                             </div>
                                             ...
                                             <div class="col-lg-4">
                                                 <input type="text" class="form-control" name="ref" id="ref" placeholder="ref..." readonly value="<?=$res_hdr['ref']?>">
										                    ...
										                    <div class="form-group">
                                             <label class="col-lg-2 col-sm-2 control-label" style="text-align:left">Tanggal SK</label>
                                             <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table id="" class="" rules="all">
                                                <thead>
                                                    ...
                                                    <?php
                          														$no = 1;
                          														while($res_dtl = mysql_fetch_array($q_sk_dtl)) { 
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <td style="text-align: right"><?=number_format($res_dtl['qty_sk'], 2)?></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
                  ...
                  <h4 class="modal-title"><?=$res_hdr['kode_sk']?></h4>
               </div>
