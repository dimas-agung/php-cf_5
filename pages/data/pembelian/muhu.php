                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <form action="" method="post" enctype="multipart/form-data" id="form-muhu">   
                            ...
                            <div class="form-group col-md-12" style="text-align: center">
                                    ...
                                    while($res = mysql_fetch_array($q_akses)) {; ?>    
                                      ...
                                      ?>  
                                          ...
                                          <!-- <button type="button" name="submit" class="btn btn-primary muhu-load" tabindex="10"><i class="fa fa-search" ></i> Cari </button> -->
                                    <?php } } } ?>
                                          <button type="button" name="submit" class="btn btn-primary muhu-load" tabindex="10"><i class="fa fa-search" ></i> Cari </button> 
                            </div>
...
$('.muhu-load').click(function(){
        var value = $(this).attr('data'); 
        data = $("#form-muhu").serialize();
        $(".animated").show();
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>ajax/j_muhu.php?func=muhu-load',
            data: data,
            cache: false,
