                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <form action="" method="post" enctype="multipart/form-data" id="form-kahu">   
                            ...
                            <div class="form-group col-md-12" style="text-align: center">
                                    ...
                                    while($res = mysql_fetch_array($q_akses)) {; ?>    
                                      ...
                                      ?>  
                                          ...
                                          <!-- <button type="button" name="submit" class="btn btn-primary kahu-load" tabindex="10"><i class="fa fa-search" ></i> Cari </button> -->
                                    <?php } } } ?>
                                          <button type="button" name="submit" class="btn btn-primary kahu-load" tabindex="10"><i class="fa fa-search" ></i> Cari </button> 
                            </div>
...
$('.kahu-load').click(function(){
        var value = $(this).attr('data'); 
        data = $("#form-kahu").serialize();
        $(".animated").show();
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>ajax/j_kahu.php?func=kahu-load',
            data: data,
            cache: false,
